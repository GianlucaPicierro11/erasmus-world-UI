...
import { UploadedImageModel } from '@core/app-access/models/uploaded-image.model';
...
export class ImageService {
    ...
    validateImage(image: UploadedImageModel): string | null {
    ...
    validExtension(image: UploadedImageModel): boolean {
